...
<details>
  ...
  - Após a instalação, você pode executar `npm run compose:up` para subir os containers da aplicação e acessar o endereço `localhost:3000` no seu navegador para utilizar das funcionalidades da aplicação.
